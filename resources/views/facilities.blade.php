                  ...
                  <div class="card card-small mb-4">
                      <div class="card-header border-bottom">
												<div class="row">
														...
														<button style="float:right" type="submit" value="Save" class="btn btn-sm btn-accent ml-auto">
															<i class="material-icons">file_copy</i> Tambahkan Fasilitas</button>	
														</div>
												</div>
											</div>
                              ...
                              <td>
                                <div class="btn-group btn-group-toggle mb-3" data-toggle="buttons">
                                  <label class="btn btn-white active">
                                    <input type="radio" name="options" id="option1" autocomplete="off" checked> Hapus </label>
                                  <label class="btn btn-white">
                                    <input type="radio" name="options" id="option2" autocomplete="off"> Edit </label>
                                </div>
                              </td>
                            </tr>
                          </tbody>
